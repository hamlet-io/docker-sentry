...
def env(field_name, default=None):
    raw_value = os.environ.get(field_name, default)
    if raw_value:
...
SENTRY_SINGLE_ORGANIZATION = bool(env('SENTRY_SINGLE_ORGANIZATION')) or True
SENTRY_BEACON = bool(env('SENTRY_BEACON')) or False
SENTRY_FEATURES['auth:register'] = bool(env('SENTRY_AUTH_REGISTER')) or False
...
if 'GITHUBAUTH_CLIENTID' in os.environ:
    GITHUB_EXTENDED_PERMISSIONS = ['repo']
    GITHUB_APP_ID = env('GITHUBAUTH_CLIENTID')
    GITHUB_API_SECRET = env('GITHUBAUTH_SECRET')
